'(:title "Static Select Test"
  :name "static-select-test"
  :version "0.1"
  :domain "static-select-test.demo.data-ui.com"
  ...
  (:todos
    (:table t
      ...
      (:name
        ...
        :priority
        (:type :text
          :ui (:label "Priority" :widget :select
               :options ("high" "medium" "low"))
          :source (:view :main :column :priority :agg :first)
          :column t)
        :points
